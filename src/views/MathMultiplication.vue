        ...
        <div id="no-print" class="row">
          <div class="col align-self-center">
            <div class="form-row">
              ...
              <MathFnButtons :pageId="'mathMultiplication'" :components="['answer', 'generator', 'print', 'help']" v-on:show-answer="onShowAnswer" v-on:generate-values="handleGenerateValues"/>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col align-self-center">
            <h3>Multiplying numbers {{ fdigit }} digit(s) by {{ sdigit }} digit(s).</h3>
          </div>
        </div>
      </div>
    </section>
    <div class="container" :class="hasAnswer ? 'printable-questions' : ''">
      <div class="row d-none d-print-inline">
        <div class="col text-center">
          <h1>Mathematics Multiplication - {{ fdigit }} digit(s) by {{ sdigit }} digit(s).</h1>
        </div>
      </div>
      <div class="row">
        <div class="col">
          <b-container class="bv-example-row">
            <b-row cols="3">
              <b-col v-bind:key="index" v-for="(numValue, index) in numValues">
                <table class="table d-print-table">
                  <tbody>
                    <tr>
                      <td class="text-right align-bottom" style="border: 0px">
                        &#215;
                      </td>
                    ...
                    <tr>
                      <td colspan="2" style="border: 0px; height: 50px">
                        &nbsp;
                      </td>
                    </tr>
                  </tbody>
